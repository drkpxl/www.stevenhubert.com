...
- [ ] **`open-routes.mdx`**: link the GitHub repo when public, flag any roadmap items you want surfaced, and confirm openroutes.co is the canonical URL going forward.

## Decisions you owe me

- [ ] **Order numbers across all 26 entries.** I appended new entries at 13 to 26. Tier 1 newcomers (Laser Map Studio, 25/26 Ikon Pass, Corduroy, the expanded Mountain Powder) probably belong higher than some of the older agency entries. Tell me the priority order and I will re-shuffle the `order:` field across every file in one pass.
